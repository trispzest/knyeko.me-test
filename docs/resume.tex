...
Built from scratch a Windows SSH server that was compatible with OpenSSH and PuTTY clients.
[C/C++]
\end{pzentry}
...
Served on course staff for CS 3110 Data Structures and Functional Programming, CS 4820 Introduction to the Analysis of Algorithms ($\times$2), and CS 4410 Operating Systems.
[OCaml, \LaTeX, Python, C]
\end{pzentry}
